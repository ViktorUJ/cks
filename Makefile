...
run_cks_k8s_mock:
	...
	cd terraform/environments/cks-mock/ && terragrunt run-all apply --terragrunt-parallelism 4


delete_cks_k8s_mock:
	@echo "*** delete cks mock "
	cd terraform/environments/cks-mock/ && terragrunt run-all destroy --terragrunt-parallelism 4
	rm -rf terraform/environments/cks-mock/*
