...
- ``TASK=01 make run_ckad_mock_clean`` - create mock  CKAD exam [number 01](tasks%2Fcks%2Fmock%2F01)  with clean terragrunt cache 
...
- ``TASK=01 make run_hr_mock`` - create mock  hr exam [number 01](tasks%2hr%2Fmock%2F01)
- ``make delete_hr_mock`` - delete mock  hr exam
- ``make clean_hr_mock`` clean terragrunt cache  for  hr_mock
- ``TASK=01 make run_hr_mock_clean`` - create mock  CKS exam [number 01](tasks%2Fcks%2Fmock%2F01)  with clean terragrunt cache 
...
- find exam solutions in ``{mock_number}/worker/files/solutions``  [mock 1 solutions](tasks%2Fcks%2Fmock%2F01%2Fworker%2Ffiles%2Fsolutions)  and [video](https://youtu.be/0000000)
- find exam tests in ``{mock_number}/worker/files/tests.bats``
</details>
...
- find exam solutions in ``{mock_number}/worker/files/solutions``  [mock 1 solutions](tasks%2Fhr%2Fmock%2F01%2Fworker%2Ffiles%2Fsolutions)  and [video](https://youtu.be/I8CPwcGbrG8)
- find exam tests in ``{mock_number}/worker/files/tests.bats``
</details>
