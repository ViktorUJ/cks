...
inputs = {
  ...
  k8s_master = {
    ...
    cidrs              = ["0.0.0.0/0"]
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/02-11.03.2023/tasks/cks/02/scripts/master.sh"
  ...
  "node_1" = {
    ...
    runtime            = "containerd"
    runtime_script     = "template/runtime.sh"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/02-11.03.2023/tasks/cks/02/scripts/worker.sh"
