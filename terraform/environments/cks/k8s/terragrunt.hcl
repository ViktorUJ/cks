...
inputs = {
  ...
  k8s_master = {
    ...
    cidrs              = ["0.0.0.0/0"]
    utils_enable       = "true"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/master/tasks/cks/07/scripts/master.sh"
  ...
  "node_1" = {
    ...
    runtime            = "containerd"
    runtime_script     = "template/runtime.sh"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/master/tasks/cks/07/scripts/worker.sh"
