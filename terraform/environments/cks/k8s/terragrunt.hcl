...
inputs = {
  ...
  k8s_master = {
    ...
    cidrs              = ["0.0.0.0/0"]
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/TASK_108/tasks/cks/108/scripts/master.sh"
    root_volume        = {
      type = "gp3"
      size = "15"
    }
...
#   runtime            = "docker"
#   runtime_script     = "template/runtime.sh"
#   task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/TASK_108/tasks/cks/108/scripts/worker.sh"
