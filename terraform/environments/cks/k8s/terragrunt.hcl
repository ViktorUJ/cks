...
inputs = {
  ...
  k8s_master = {
    ...
    cidrs              = ["0.0.0.0/0"]
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/task_019/tasks/cks/19/scripts/master.sh"
...
#   runtime            = "cri-o"
#   runtime_script     = "template/runtime.sh"
#   task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/master/tasks/cks/17/scripts/worker.sh"
