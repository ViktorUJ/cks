...
inputs = {
  ...
  work_pc = {
    ...
    test_url          = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/AG-133/tasks/ica/labs/01/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/AG-133/tasks/ica/labs/01/worker/files/worker.sh"
    ssh = {
