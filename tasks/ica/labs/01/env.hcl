locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/AG-149/tasks/ica/labs/01/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/AG-149/tasks/ica/labs/01/worker/files/solutions/1.MD"
