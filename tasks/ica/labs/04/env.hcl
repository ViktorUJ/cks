locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/AG-146/tasks/ica/labs/04/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/AG-146/tasks/ica/labs/04/worker/files/solutions/1.MD"
