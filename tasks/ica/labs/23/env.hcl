locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/master/tasks/ica/labs/23/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/master/tasks/ica/labs/23/worker/files/solutions/1.MD"
