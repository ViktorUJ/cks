...
inputs = {
  ...
  k8s_master = {
    ...
    eip                = "false"
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/ica/labs/33/k8s-1/scripts/master.sh"
  ...
  k8s_worker = {
    "node_1" = {
      ...
      task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/ica/labs/33/k8s-1/scripts/worker.sh"
