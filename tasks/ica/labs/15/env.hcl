locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/AG-150/tasks/ica/labs/15/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/AG-150/tasks/ica/labs/15/worker/files/solutions/1.MD"
