locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/AG-151/tasks/ica/labs/17/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/AG-151/tasks/ica/labs/17/worker/files/solutions/1.MD"
