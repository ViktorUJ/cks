#!/bin/bash
echo " *** master node ica lab-28 k8s-1 (TCP routing)"
...
# Install Istio; expose a fixed TCP NodePort (31400) on the ingress gateway so
# the worker PC can reach the TCP service at myapp.local:31400.
