locals {
  questions_list = "https://github.com/ViktorUJ/cks/blob/AG-117/tasks/cks/mock/01/README.MD"
  solutions_scripts="https://github.com/ViktorUJ/cks/tree/master/AG-117/tasks/cks/mock/01/worker/files/solutions"
  solutions_video="N/A"
  debug_output   = "true"
  region         = "eu-north-1"
