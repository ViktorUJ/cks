...
@test "11.1 Pod sleep-indigo exists in indigo namespace" {
...
@test "11.2 Pod has 2 containers (app + istio-proxy)" {
...
@test "11.3 istio-proxy container exists" {
  echo '1' >> /var/work/tests/result/all
...
@test "11.4 Namespace does NOT have auto-injection label" {
  echo '0.5' >> /var/work/tests/result/all
