...
@test "13.1 DestinationRule exists with subsets v1 and v2" {
...
@test "13.2 DestinationRule has v1 subset with version label" {
  echo '0.5' >> /var/work/tests/result/all
...
@test "13.3 VirtualService routes 100% traffic to v1" {
  echo '0.5' >> /var/work/tests/result/all
...
@test "13.4 v2 receives no traffic (weight 0 or not in route)" {
  echo '0.5' >> /var/work/tests/result/all
