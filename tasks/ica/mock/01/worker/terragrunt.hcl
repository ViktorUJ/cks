...
inputs = {
  ...
  work_pc = {
    ...
    test_base_url     = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-117/tasks/ica/mock/01/worker/files/tests"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-117/tasks/ica/mock/01/worker/files/worker-ica.sh"
    ssh               = {
