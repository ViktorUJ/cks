...
inputs = {
  ...
  k8s_master = {
    ...
    eip                = "false"
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-117/tasks/ica/mock/02/k8s-3/scripts/master.sh"
  ...
  k8s_worker = {
    "node_1" = {
      ...
      runtime_script     = "template/runtime.sh"
      task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-117/tasks/ica/mock/02/k8s-3/scripts/worker.sh"
