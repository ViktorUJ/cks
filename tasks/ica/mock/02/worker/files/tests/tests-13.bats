...
@test "13.1 istiod deployment exists with revision 1-26-3" {
...
@test "13.2 Egress gateway deployment exists" {
  echo '0.5' >> /var/work/tests/result/all
...
@test "13.3 Pilot resources - CPU request is 100m" {
  echo '0.5' >> /var/work/tests/result/all
...
@test "13.4 Pilot resources - Memory request is 200Mi" {
  echo '0.5' >> /var/work/tests/result/all
