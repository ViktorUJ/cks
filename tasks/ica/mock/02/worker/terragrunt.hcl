...
inputs = {
  ...
  work_pc = {
    ...
    test_base_url     = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-121/tasks/ica/mock/02/worker/files/tests"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-121/tasks/ica/mock/02/worker/files/worker-ica.sh"
    ssh               = {
