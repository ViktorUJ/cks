...
(`README_FR.MD`), Deutsch (`README_DE.MD`), Georgisch (`README_GE.MD`), traditionelles
Chinesisch (`README_TW.MD`) und Japanisch (`README_JP.MD`). Sie stellen echte Cluster in AWS über
Terragrunt bereit:
