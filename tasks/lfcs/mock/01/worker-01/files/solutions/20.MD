...
# exit from ssh session, check ip addr of node01, and SSH to node02 again
exit
ip addr
ssh node02
# or without exiting your can run  and grub ip here if you're connected from node01
w
...
- *without applied rule it looks so:*
...
- *After applying rule. Put your attention to the first two records (this is ip adresses of node01)*
