...
|     Task weight     | 2%                                                                                                                                                                                                                                                          |
|       Cluster       | cluster1 (`kubectl config use-context cluster1-admin@cluster1`)                                                                                                                                                                                             |
| Acceptance criteria | - name: `cron-job1` <br/>- namespace: `rnd`  <br/>- image: `viktoruj/ping_pong:alpine` <br/>-  Concurrency policy: `Forbid` <br/>-  command: `echo "Hello from CKAD mock"`  <br/>-  run every 15 minutes |
