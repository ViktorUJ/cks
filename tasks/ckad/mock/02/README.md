...
|     Task weight     | 6%                                                                                                                                                                                                                                                                                    |
|       Cluster       | cluster1 (`kubectl config use-context cluster1-admin@cluster1`)                                                                                                                                                                                                                       |
| Acceptance criteria | - new version of app has 30% of requests <br/>- new version has  image `viktoruj/ping_pong:latest`  and  env `SERVER_NAME=appV2` <br/>- total replicas `10`                                                                                                                           |
