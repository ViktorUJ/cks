...
# task 6
kubectl  apply -f  https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/02/k8s-1/scripts/task6.yaml
...
# task 12
kubectl  apply -f  https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/02/k8s-1/scripts/task12.yaml

# task 16
kubectl  apply -f  https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/02/k8s-1/scripts/task16.yaml

# task 17
kubectl  apply -f  https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/02/k8s-1/scripts/task17.yaml

# task 18
kubectl  apply -f  https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/02/k8s-1/scripts/task18.yaml
...
helm install ingress-nginx  ingress-nginx/ingress-nginx \
  ...
  --version 4.8.3 \
  -f https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/01/k8s-1/scripts/ingress_nginx_conf.yaml
