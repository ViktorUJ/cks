...
inputs = {
  ...
  k8s_master = {
    ...
    eip                = "false"
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/01/k8s-1/scripts/master.sh"
  ...
  k8s_worker = {
    ...
    "node_2" = {
      ...
      runtime_script     = "template/runtime.sh"
      task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-26/tasks/ckad/mock/01/k8s-1/scripts/worker.sh"
