locals {
  questions_list="https://github.com/ViktorUJ/cks/blob/0.9.1/tasks/ckad/mock/02/README.md"
  solutions_scripts="https://github.com/ViktorUJ/cks/tree/0.9.1/tasks/ckad/mock/02/worker/files/solutions"
  solutions_video=""
  region = "eu-north-1"
