...
- **лимит на частоту** изменений одного тома: исторически - кулдаун около шести часов, сейчас
  несколько изменений в скользящие 24 часа; частые расширения подряд упрутся в ограничение
  (сверяйтесь с документацией EBS).
