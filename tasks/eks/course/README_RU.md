...
Кроме глав и лаб, у курса есть рабочие справочники - их читают не подряд, а по нужде:

- [Глоссарий курса](GLOSSARY_RU.md) - все термины по главам со ссылками
- [Диагностический справочник](RUNBOOK_RU.md) - симптом, причина, проверка: Часть 8 в сводке
- [Архитектурные решения (ADR)](ADR_RU.md) - шаблоны решений по развилкам курса
- [Матрица зрелости EKS](SCORECARD_RU.md) - опросник готовности кластера по восьми доменам
- [Модель затрат](COST_MODEL_RU.md) - перечень статей и формулы, ставки подставляете свои
...
дежурстве удобнее открывать его, а не три главы.

### Часть 9. Итог

48. [Продакшн-чеклист EKS и что читать дальше](48/ru.md)

Чеклисты главы 48 в виде опросника с баллом и списком техдолга -
[матрица зрелости EKS](SCORECARD_RU.md).

## Практика

У курса свой набор лабораторных работ с нумерацией `101+`, привязанных к главам. Лабы
разворачиваются в вашем аккаунте AWS через Terragrunt, проверяются автоматически через
`check_result` и удаляются одной командой:

- 🧪 [Лабораторные работы EKS](../../../docs/labs.MD#eks-labs) - список лаб и команды запуска

Набор лаб курса сейчас в работе. Значок 🧪 в оглавлении означает, что у главы уже есть
своя лаба; главы без значка пока проходятся как теория.

Отдельно в репозитории есть более ранние лабы EKS ([Karpenter](../labs/02/README_RUS.MD),
[автомасштабирование с KEDA и Prometheus](../labs/03/README_RUS.MD)). Они не входят в
курс и живут своей жизнью, но темы пересекаются с главами 12 и 35, поэтому их можно
пройти как дополнительную практику.
