...
Лаба курса к этой теме: [лаба 119 - Troubleshooting: нода не доходит до Ready (IAM, SG, user
data, kubelet)](../../labs/119/README_RU.MD). Своей отдельной лабы у главы нет: это
диагностический runbook, который отрабатывают на живом кластере. Но
