...
- **Подготовка автоматизирована.** Cluster insights смотрят регулярно, инвентаризация
  устаревших API входит в CI, матрица версий аддонов обновляется перед каждым циклом.
