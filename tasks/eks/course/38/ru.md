...
устаревшие API](../../labs/113/README_RU.MD). Кроме неё, готовность к апгрейду и текущее
состояние версий легко снять на живом кластере. Сначала посмотрите версию кластера и сколько
ей осталось в standard support:
