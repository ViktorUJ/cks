...
К этой теме идут две лабы курса: [лаба 110 - NetworkPolicy в EKS: встроенная VPC CNI network
policy](../../labs/110/README_RU.MD) и [лаба 132 - Альтернативный CNI: Cilium в режиме CNI
chaining над VPC CNI](../../labs/132/README_RU.MD). Кроме них, всё проверяется на живом
кластере. Сначала выясните, включён ли
