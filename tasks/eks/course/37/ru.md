...
устаревшие API](../../labs/113/README_RU.MD). Кроме неё, состояние аддонов и их версий легко
снять на живом кластере. Сначала посмотрите, что установлено как managed addon и в каком
статусе:
