locals {
  ...
  questions_list    = "https://github.com/ViktorUJ/cks/blob/${local.git_branch}/tasks/eks/labs/109/README_RU.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/${local.git_branch}/tasks/eks/labs/109/worker/files/solutions/1.MD"
  ...
  # Тестовый домен приватной hosted zone, привязанной к VPC этой лабы (глава 29).
  zone_domain      = "eks-task109.internal"
  cert_common_name = "app.eks-task109.internal"
  subnets = {
    public = {
      "pub1" = {
        name        = "eks-AZ-1"
