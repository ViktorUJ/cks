...
| მიღების კრიტერიუმები    | - `disallow-latest-tag-binding`-ს აქვს `validationActions: ["Deny"]`;<br/>- Pod `latest-deny-pod` `eks-127`-ში არ არსებობს;<br/>- ფაილი `denied.txt` არ არის ცარიელი და შეიცავს სიტყვებს `latest` და `запрещён`. |
---
