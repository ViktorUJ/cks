#!/bin/bash
# *** worker pc, EKS course lab 131 (PDB blocks drain, topology spread) ***
# Ничего не сеем заранее: студент создаёт все объекты сам.
# Ждём, пока кластер станет доступен и появятся ноды минимум в двух зонах.
export KUBECONFIG=/root/.kube/config

echo "*** eks course lab 131 ***"
...
echo "*** cluster is ready, you can start lab 131 ***"
