locals {
  ...
  questions_list    = "https://github.com/ViktorUJ/cks/blob/${local.git_branch}/tasks/eks/labs/113/README_RU.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/${local.git_branch}/tasks/eks/labs/113/worker/files/solutions/1.MD"
  ...
  prefix = "eks-task113"
  tags = {
    "env_name"        = "eks-task113"
    "env_type"        = "dev"
    "manage"          = "terraform"
    "cost_allocation" = "dev"
    "owner"           = "viktoruj@gmail.com"
  }
  # Кластер стартует на 1.35 (на минор ниже последней GA 1.36), чтобы в лабе
  # можно было выполнить реальный апгрейд на 1.36 и затем откат обратно на 1.35
  # в течение 7-дневного окна rollback.
  k8_version           = "1.35.0"
