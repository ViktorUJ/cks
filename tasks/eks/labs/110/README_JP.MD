...
- [第 8 章。詳解ネットワーキング:VPC CNI と代替 CNI](../../course/08/jp.md) - 組み込みのネットワークポリシーと Cilium の境界
- [第 30 章。NetworkPolicy:ルール、DNS、テスト](../../course/30/jp.md) - default deny、ラベルと namespace による許可、egress
