...
- [თავი 8. ქსელი დეტალურად: VPC CNI და ალტერნატიული CNI-ები](../../course/08/ru.md) - ჩაშენებული ქსელური პოლიტიკის საზღვრები Cilium-თან შედარებით
- [თავი 30. NetworkPolicy: წესები, DNS, ტესტირება](../../course/30/ru.md) - ნაგულისხმევი აკრძალვა, დაშვება ლეიბლითა და namespace-ით, egress
