...
- [თავი 6. კლასტერის ქსელი: VPC CNI, ENI და IP-მისამართები, CIDR-ის
  დაგეგმვა](../../course/06/ru.md) - საიდან იღებენ პოდები მისამართებს და როგორ ითვლება
  პოდების ლიმიტი
- [თავი 7. მისამართების გეგმის მასშტაბირება: prefix delegation, secondary CIDR, custom
  networking](../../course/07/ru.md) - რა ვქნათ, როცა მისამართები აღარ არის საკმარისი
- [თავი 14. სიმჭვრეტე და sizing: pods per node, ENI-ის ლიმიტები, requests და limits
  ღრუბელში](../../course/14/ru.md) - როგორ ემთხვევა მისამართების ლიმიტი რესურსების
  ლიმიტს
