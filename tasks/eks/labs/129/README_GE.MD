...
- [თავი 25. S3 აპლიკაციებში: Mountpoint for Amazon S3 CSI და წვდომის
  პატერნები](../../course/25/ge.md) - ლაბის ძირითადი მასალა
- [თავი 41-42. AWS Backup EKS-სთვის](../../course/41/ge.md) - რატომ არ გამოდგება
  აქ EBS-სნეპშოტები
...
| მიღების კრიტერიუმები    | - ფაილი `5/writesemantics.txt` არ არის ცარიელი;<br/>- შეიცავს `Operation not permitted`-ს;<br/>- შეიცავს სულ მცირე ერთს `append`, `rename`-იდან. |
---
...
| მიღების კრიტერიუმები    | - ფაილი `6/backup.txt` არ არის ცარიელი;<br/>- შეიცავს `versioning`-ს და `snapshot`-ს;<br/>- შეიცავს `Enabled`-ს (bucket-ის versioning-ის დადასტურებული სტატუსი). |
---
