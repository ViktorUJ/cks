...
- [თავი 15. Fargate: პროფილები, შეზღუდვები, ღირებულება, გამოყენების სცენარები](../../course/15/ru.md)
...
| :-----------------: | :---------------------------------------------------------- |
| რას ვაკეთებთ          | აღწერეთ გადახდის მოდელის განსხვავება `3-5` წინადადებაში: Fargate ტარიფდება vCPU-სა და მეხსიერებაზე თვითონ ᲙᲘ პოდის მიხედვით, მისი ცხოვრების ხანგრძლივობის განმავლობაში, უსაქმური ტევადობის გადასახადის გარეშე; node group ტარიფდება მთელ ინსტანსზე, იმ დროის ჩათვლით, როცა ის არასრულად არის დატვირთული. შეინახეთ ტექსტი ფაილში `/var/work/tests/artifacts/6/costmodel.txt`. დოლარებში ჯამების გარეშე - მხოლოდ ტარიფიკაციის სტრუქტურა. ავტომატური შემოწმება ეძებს ლიტერალურ სიტყვას `под` (რუსულად "პოდი") `vCPU`-ს გვერდით, ამიტომ დარწმუნდით, რომ ეს ლიტერალური სიტყვა `под` ტექსტში ჩართული გაქვთ, ქართული განმარტების გარდა. |
| მიღების კრიტერიუმები    | - ფაილი არ არის ცარიელი;<br/>- შეიცავს `vCPU`-ს, `под`-ს (ლიტერალური რუსული სიტყვა, რომელსაც მოითხოვს ავტომატური შემოწმება) და მინიმუმ ერთს `node group` / `нод` / `инстанс`-დან. |
---
