...
- [Подготовка окружения](#setup)
  - [Запуск лабораторной работы](#running-the-lab)
  - [Создаваемые ресурсы](#created-resources)
  - [Предварительные требования](#prerequisites)
- [Базовая настройка NodePool](#basic-nodepool)
...
- [Масштабирование приложений](#scaling-application)
...
- [Ограничение ресурсов](#limit-resources)
  - [Настройка лимитов CPU](#настройка-лимитов-cpu)
  - [Диагностика проблем с лимитами](#диагностика-проблем-с-лимитами)
- [Управление жизненным циклом узлов (Disruption)](#disruption)
- [Оптимизация размеров узлов (RightSizing)](#rightsizing)
...
- [Обновление конфигурации узлов (Drift)](#drift)
...
- [Работа с несколькими NodePool](#multi-nodepools)
