...
- [თავი 8. VPC CNI-ის ალტერნატივები: Cilium, ქსელის რეჟიმები](../../course/08/ru.md) -
  CNI chaining სრული ჩანაცვლების წინააღმდეგ, გადასვლის ჯანსაღი ფასი
- [თავი 30. NetworkPolicy: წესები, DNS, ტესტირება](../../course/30/ru.md) - VPC CNI-ის
...
| მიღების კრიტერიუმები    | - ფაილი `8/comparison.txt` არ არის ცარიელი;<br/>- შეიცავს სიტყვებს `L7`, `FQDN`, `Hubble`;<br/>- შეიცავს ხსენებას chapter 8-ის შესახებ (`глава 8` ან `chapter 8`) და სიტყვას `blue` (`blue/green`-იდან). |
---
