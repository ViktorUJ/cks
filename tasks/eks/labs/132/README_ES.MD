...
| Criterios de aceptación    | - el archivo `8/comparison.txt` no está vacío;<br/>- contiene las palabras `L7`, `FQDN`, `Hubble`;<br/>- contiene una mención del chapter 8 (`глава 8` o `chapter 8`) y la palabra `blue` (de `blue/green`). |
---
