...
- [თავი 24. EFS და FSx: გაზიარებული საცავი დატვირთვებისთვის AZ-ებს შორის](../../course/24/ge.md) - ამ ლაბის მთავარი მასალა
- [თავი 23. EBS CSI: gp3, StorageClass, გაფართოება, snapshots, AZ-სთან მიბმა](../../course/23/ge.md) - რასთან ვადარებთ: ზონალური ბლოკური ტომი რეგიონული ქსელური ტომის წინააღმდეგ
- [თავი 9. გამოთვლის ტიპები: managed node groups, Fargate, Auto Mode](../../course/09/ge.md) - რატომ აქვს კლასტერს რამდენიმე AZ და სად ცხოვრობენ ნოუდები
- [თავები 16-17. IRSA და Pod Identity](../../course/16/ge.md) - როგორ იღებს დრაივერი უფლებას EFS-ის მართვისთვის
...
while kubectl get nodes --no-headers 2>/dev/null | grep -qv fargate; do
  echo "Karpenter-ის EC2 ნოდი ჯერ კიდევ ცოცხალია, ველოდებით..."; sleep 15
done
```
