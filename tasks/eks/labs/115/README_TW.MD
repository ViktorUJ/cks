...
- [第 34 章。日誌:Fluent Bit、CloudWatch Logs、OpenSearch、成本控制](../../course/34/tw.md)
...
flowchart TB
    ...
    fb["Fluent Bit DaemonSet<br>IRSA 角色"]
    filt["FILTER grep<br>丟棄 /healthz"]
    cw["CloudWatch Logs<br>log group"]
    ret["Retention<br>7 天"]
