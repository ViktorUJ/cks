...
- [თავი 16. IRSA: OIDC-პროვაიდერი, trust policy, ServiceAccount-ის ანოტაციები](../../course/16/ru.md)
- [თავი 17. EKS Pod Identity: აგენტი, ასოციაციები, IRSA-დან მიგრაცია](../../course/17/ru.md)
