...
- [Capítulo 16. IRSA: el proveedor OIDC, la trust policy, las anotaciones de ServiceAccount](../../course/16/es.md)
- [Capítulo 17. EKS Pod Identity: el agente, las asociaciones, la migración desde IRSA](../../course/17/es.md)
