...
- [Chapter 16. IRSA: the OIDC provider, trust policy, ServiceAccount annotations](../../course/16/ru.md)
- [Chapter 17. EKS Pod Identity: the agent, associations, migrating from IRSA](../../course/17/ru.md)
