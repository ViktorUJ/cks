locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/master/tasks/cka/labs/10/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/master/tasks/cka/labs/10/worker/files/solutions/1.MD"
  solutions_video   = "none"
  debug_output      = "false"
  region            = "eu-north-1"
