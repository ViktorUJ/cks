...
inputs = {
  ...
  k8s_master = {
    ...
    eip                = "false"
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/AG-96/tasks/cka/labs/10/k8s-1/scripts/master.sh"
  ...
  k8s_worker = {
    ...
    "app" = {
      ...
      runtime_script     = "template/runtime.sh"
      task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/AG-96/tasks/cka/labs/10/k8s-1/scripts/worker.sh"
