...
- [თავი 20. SecurityContext და capabilities](../../course/20/ru.md) — `runAsUser`, `fsGroup`, capabilities, `allowPrivilegeEscalation`, `privileged`
- [თავი 21. ServiceAccount; authn/authz/admission](../../course/21/ru.md) — უსაფრთხოების კონტექსტი წვდომის საერთო მოდელში
