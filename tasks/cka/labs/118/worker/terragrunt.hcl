...
inputs = {
  ...
  work_pc = {
    ...
    test_url          = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/cka/labs/118/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/cka/labs/118/worker/files/worker.sh"
    ssh = {
