...
inputs = {
  ...
  host_list         = concat(dependency.node02.outputs.hosts_list, dependency.node03.outputs.hosts_list)
  debug_output      = true
  ...
  work_pc = {
    ...
    test_url           = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/cka/labs/124/node-1/files/tests.bats"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/cka/labs/124/node-1/files/worker.sh"
    ssh = {
