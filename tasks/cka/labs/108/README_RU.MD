...
| Критерии приёмки    | - Pod: `analytics`, image `viktoruj/ping_pong:alpine`<br/>- Использует PVC `pvc-analytics`, mountPath `/pv/analytics`<br/>- Работает на ноде с меткой `node=node_2` |
---
