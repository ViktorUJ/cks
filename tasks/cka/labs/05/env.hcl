locals {
  questions_list = "https://github.com/ViktorUJ/cks/blob/master/tasks/cka/labs/05/README.MD"
  solutions_scripts="https://github.com/ViktorUJ/cks/blob/master/tasks/cka/labs/05/worker/files/solutions/1.MD"
  solutions_video="https://youtu.be/7MhXfbiMfOM"
  debug_output   = "false"
  region = "eu-north-1"
