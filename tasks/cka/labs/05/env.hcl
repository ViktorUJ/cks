locals {
  questions_list = "https://github.com/ViktorUJ/cks/blob/AG-17/tasks/cka/labs/05/README.MD"
  solutions_scripts="https://github.com/ViktorUJ/cks/blob/AG-17/tasks/cka/labs/05/worker/files/solutions/1.MD"
