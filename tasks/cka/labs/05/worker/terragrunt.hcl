...
inputs = {
  ...
  work_pc = {
    ...
    test_url          = "https://raw.githubusercontent.com/ViktorUJ/cks/0.12.1/tasks/cka/labs/05/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/0.12.1/tasks/cka/labs/05/worker/files/worker.sh"
    ssh = {
