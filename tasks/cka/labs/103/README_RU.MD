...
| Критерии приёмки    | - Неймспейс: `app-system`<br/>- DaemonSet: `important-app`, image `viktoruj/ping_pong:latest`<br/>- Под работает на **всех** нодах (desired = numberReady = число нод) |
---
