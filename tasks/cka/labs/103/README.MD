...
- [Chapter 10. Jobs and CronJobs](../../course/10/README.md) — one-off and scheduled tasks, `completions`, `backoffLimit`, `restartPolicy`, schedule, `concurrencyPolicy`
- [Chapter 11. DaemonSet and StatefulSet](../../course/11/README.md) — running a Pod on every node, toleration for the control-plane
