...
- [Chapitre 10. Jobs et CronJobs](../../course/10/ru.md) — tâches ponctuelles et périodiques, `completions`, `backoffLimit`, `restartPolicy`, planification, `concurrencyPolicy`
- [Chapitre 11. DaemonSet et StatefulSet](../../course/11/ru.md) — lancer un Pod sur chaque nœud, toleration pour le control-plane
