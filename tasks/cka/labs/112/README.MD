...
- [Chapter 37. etcd Backup and Restore](../../course/37/ru.md) — `snapshot save`/`status`/`restore`, stopping and starting the control plane static Pods, restoring etcd data, checking cluster health
