locals {
  questions_list = "https://github.com/ViktorUJ/cks/blob/0.13.1/tasks/cka/labs/07/README.MD"
  solutions_scripts="https://github.com/ViktorUJ/cks/blob/0.13.1/tasks/cka/labs/07/worker/files/solutions/1.MD"
  solutions_video=""
  debug_output   = "false"
  region = "eu-north-1"
