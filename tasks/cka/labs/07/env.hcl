locals {
  questions_list = "https://github.com/ViktorUJ/cks/blob/AG-32/tasks/cka/labs/07/README.MD"
  solutions_scripts="https://github.com/ViktorUJ/cks/blob/AG-32/tasks/cka/labs/07/worker/files/solutions/1.MD"
