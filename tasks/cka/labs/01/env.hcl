locals {
  questions_list = "https://github.com/ViktorUJ/cks/blob/AG-36/tasks/cka/labs/01/README.MD"
  solutions_scripts="https://github.com/ViktorUJ/cks/blob/AG-36/tasks/cka/labs/01/worker/files/solutions/1.MD"
  solutions_video="xyz"
  debug_output   = "false"
  region = "eu-north-1"
