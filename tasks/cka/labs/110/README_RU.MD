...
| Критерии приёмки    | - Pod `nginx-resolver` (viktoruj/ping_pong:latest) + Service `nginx-resolver-service` (Endpoints не пусты)<br/>- Записи сохранены в `/var/work/tests/artifacts/dns/nginx.svc` и `.../nginx.pod` |
---
