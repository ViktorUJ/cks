...
|     Task weight     | 4%                                                                                                                                                                                                                                                                                                         |
|       Cluster       | cluster1 (`kubectl config use-context cluster1-admin@cluster1`)                                                                                                                                                                                                                                            |
| Acceptance criteria | - DaemonSet: `team-elephant-ds`<br/> - Namespace: `team-elephant`<br/> - Image: `viktoruj/ping_pong`<br/> - Labels: `team=team-elephant`, `env=dev` <br/> - requests CPU: `100m`<br/> - requests  Memory: `128Mi`<br/> Pods are running on all nodes, including control plane, in Namespace team-elephant. |
---
