...
|     Task weight     | 6%                                                                                                                                                                                                                                                                                                                                                          |
|       Cluster       | cluster1 (`kubectl config use-context cluster1-admin@cluster1`)                                                                                                                                                                                                                                                                                             |
| Acceptance criteria | - create ns development<br/>- create private key , and csr<br/>- CSR: john-developer Status:Approved<br/>- Role Name: developer, namespace: development, Resource: Pods , verbs: create,list,get<br/>- rolebinding : name=developer-role-binding , role=developer,  user=john , namespace=development<br/>- Access: User 'john' has appropriate permissions |
---
