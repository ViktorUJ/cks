...
Лабы нашей платформы - основная практика курса, и они лучше подходят для подготовки к
экзамену: они составные (несколько связанных заданий в одном окружении, как на реальном
экзамене), разворачиваются в полноценном кластере с доступом на ноды по SSH, проверяются
автоматически через `check_result`, а мок-экзамены идут под таймером с весами заданий.
Именно это воспроизводит условия CKA и CKAD.

Сценарии Killercoda в главах - это **быстрый старт**: открываются в браузере, не требуют
установки и бесплатны. Их удобно пройти сразу после чтения главы, чтобы закрепить одну
узкую тему, или потренироваться, когда кластера под рукой нет. Но они атомарные (один
сценарий - одно задание), только на английском и не дают ни работы на нодах, ни репетиции
под таймером.

Рекомендуемая связка: Killercoda - для быстрого закрепления темы, наши лабы и мок-экзамены -
для подготовки к самому экзамену.
