...
русский (`ru.md`), с него сделаны переводы: английский (`README.md`), испанский
(`es.md`), французский (`fr.md`), немецкий (`de.md`) и грузинский (`ge.md`).
Переключатель языков - в первой строке каждого файла.
...
- 🧪 [Лабораторные работы](../labs) - 25 лаб в стиле экзамена с автопроверкой `check_result`
- 🧪 [Мок-экзамены CKA](../mock) - мок-экзамены CKA под таймером (мультикластер, SSH, веса заданий)
- 🧪 [Мок-экзамены CKAD](../../ckad/mock) - мок-экзамены CKAD под таймером

## Что читать дальше

Этот курс сфокусирован на подготовке к экзаменам: каждая глава привязана к домену CKA
или CKAD. Архитектурная философия, история проекта и обзор экосистемы (service mesh,
GitOps, observability) сюда сознательно не включены - это отдельные темы, которые на
экзамене не спрашивают. Если хочется шире и глубже:

- **Kubernetes: Up and Running** (Burns, Beda, Hightower, O'Reilly) - зачем Kubernetes
  появился, эволюция от Borg, архитектурные паттерны приложений.
- **The Kubernetes Book** (Nigel Poulton) - обзорное введение с акцентом на понимание
  платформы целиком; обновляется каждый год.
- [Официальная документация Kubernetes](https://kubernetes.io/docs/) - первоисточник,
  разрешена к использованию на самом экзамене.
- [CNCF Landscape](https://landscape.cncf.io/) - карта экосистемы cloud native.
