[Eng version](CKA.md) · [Versión en español](CKA_ES.md) · [Version française](CKA_FR.md) · [Deutsche Version](CKA_DE.md) · [ქართული ვერსია](CKA_GE.md) · [繁體中文版](CKA_TW.md) · [日本語版](CKA_JP.md)
...
- [0.8. vim за 15 минут: выжить и настроить под YAML](00-8-vim/ru.md) - **важно для CKA** (правка манифестов на нодах по SSH)
...
- [20. SecurityContext и capabilities](20/ru.md) · [21. ServiceAccount, аутентификация и admission](21/ru.md)
...
| 🟢 Services & Networking — 20% | [101](../labs/101/README_RU.MD) (Service), [110](../labs/110/README_RU.MD) (DNS, Ingress, Gateway API + миграция, NetworkPolicy), [125](../labs/125/README_RU.MD) (DNS/CoreDNS), [120](../labs/120/README_RU.MD) (networking-дриллы), [118](../labs/118/README_RU.MD) (CoreDNS/сеть), [123](../labs/123/README_RU.MD) (установка CNI с нуля) |
| 🟣 Workloads & Scheduling — 15% | [101](../labs/101/README_RU.MD) (Deployment), [102](../labs/102/README_RU.MD) (обновления/стратегии), [103](../labs/103/README_RU.MD) (Jobs/CronJob/DaemonSet), [104](../labs/104/README_RU.MD) (планирование/HPA), [122](../labs/122/README_RU.MD) (scheduling-дриллы), [105](../labs/105/README_RU.MD) (ConfigMap/Secret), [106](../labs/106/README_RU.MD) (SecurityContext), [119](../labs/119/README_RU.MD) (дриллы/JSONPath) |
