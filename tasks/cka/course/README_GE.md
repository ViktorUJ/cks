...
### რომელი ლაბები აირჩიოთ

ჩვენი პლატფორმის ლაბები კურსის ძირითადი პრაქტიკაა და უკეთ შეესაბამება გამოცდისთვის
მომზადებას: ისინი შედგენილია (რამდენიმე დაკავშირებული დავალება ერთ გარემოში, როგორც
რეალურ გამოცდაზე), იშლება სრულფასოვან კლასტერში ნოუდებზე SSH-ით წვდომით, შემოწმდება
ავტომატურად `check_result`-ით, ხოლო მოკ-გამოცდები ტაიმერით და დავალებების წონებით
მიდის. სწორედ ეს ქმნის CKA-სა და CKAD-ს პირობებს.

Killercoda-ს სცენარები თავებში - ეს **სწრაფი დაწყებაა**: იხსნება ბრაუზერში, არ საჭიროებს
ინსტალაციას და უფასოა. მოსახერხებელია თავის წაკითხვისთანავე, ერთი ვიწრო თემის
დასამაგრებლად, ან სავარჯიშოდ, როცა კლასტერი ხელთ არ არის. მაგრამ ისინი ატომარულია (ერთი
სცენარი - ერთი დავალება), მხოლოდ ინგლისურად და არ იძლევა არც ნოუდებზე მუშაობას, არც
რეპეტიციას ტაიმერით.

რეკომენდებული კომბინაცია: Killercoda - თემის სწრაფი დასამაგრებლად, ჩვენი ლაბები და
მოკ-გამოცდები - თავად გამოცდისთვის მომზადებისთვის.

## რა წავიკითხოთ შემდეგ

ეს კურსი ფოკუსირებულია გამოცდებისთვის მომზადებაზე: თითოეული თავი მიბმულია CKA-ს ან
CKAD-ს დომენზე. არქიტექტურული ფილოსოფია, პროექტის ისტორია და ეკოსისტემის მიმოხილვა
(service mesh, GitOps, დაკვირვებადობა) შეგნებულად არ არის შეტანილი - ეს ცალკე თემებია,
რომლებსაც გამოცდაზე არ კითხავენ. თუ გინდათ უფრო ფართოდ და ღრმად:

- **Kubernetes: Up and Running** (Burns, Beda, Hightower, O'Reilly) - რატომ გამოჩნდა
  Kubernetes, ევოლუცია Borg-იდან, აპლიკაციების არქიტექტურული პატერნები.
- **The Kubernetes Book** (Nigel Poulton) - მიმოხილვითი შესავალი აქცენტით პლატფორმის
  მთლიანად გაგებაზე; განახლდება ყოველწლიურად.
- [Kubernetes-ის ოფიციალური დოკუმენტაცია](https://kubernetes.io/docs/) - პირველწყარო,
  მისი გამოყენება ნებადართულია თავად გამოცდაზე.
- [CNCF Landscape](https://landscape.cncf.io/) - cloud native ეკოსისტემის რუკა.
