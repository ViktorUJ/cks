locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/master/tasks/cks/labs/27/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/master/tasks/cks/labs/27/worker/files/solutions/1.MD"
  solutions_video   = "https://youtu.be/IScbc12Nj2A"
  debug_output      = "false"
  region            = "eu-north-1"
