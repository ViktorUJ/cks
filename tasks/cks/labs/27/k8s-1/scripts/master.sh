...
kubectl apply -f https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/0.20.1/tasks/cks/labs/27/k8s-1/scripts/app.yaml
kubectl apply -f https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/0.20.1/tasks/cks/labs/27/k8s-1/scripts/default-deny.yaml
