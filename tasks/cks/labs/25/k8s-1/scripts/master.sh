...
kubectl  apply -f https://raw.githubusercontent.com/ViktorUJ/cks/master/tasks/cks/labs/25/k8s-1/scripts/task1.yaml


curl "https://raw.githubusercontent.com/ViktorUJ/cks/master/tasks/cks/labs/25/k8s-1/scripts/admission_config.json" -o "admission_config.json"
curl "https://raw.githubusercontent.com/ViktorUJ/cks/master/tasks/cks/labs/25/k8s-1/scripts/admission_kube_config.yaml" -o "admission_kube_config.yaml"
