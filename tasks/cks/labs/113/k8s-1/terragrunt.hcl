...
inputs = {
  ...
  k8s_master = {
    ...
    eip                = "false"
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-156/tasks/cks/labs/113/k8s-1/scripts/master.sh"
  ...
  k8s_worker = {
    "worker1" = {
      ...
      runtime            = local.vars.locals.runtime
      runtime_script     = "template/runtime.sh"
      task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-156/tasks/cks/labs/113/k8s-1/scripts/worker.sh"
