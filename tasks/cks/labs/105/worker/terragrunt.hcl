...
inputs = {
  ...
  host_list = concat(
    ...
    dependency.docker-host.outputs.hosts,
  )
  work_pc = {
    clusters_config = {
    ...
    test_url          = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/cks/labs/105/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/cks/labs/105/worker/files/worker.sh"
    ssh = {
