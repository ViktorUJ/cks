locals {
  questions_list    = "https://github.com/ViktorUJ/cks/blob/0.20.1/tasks/cks/labs/28/README.MD"
  solutions_scripts = "https://github.com/ViktorUJ/cks/blob/0.20.1/tasks/cks/labs/28/worker/files/solutions/1.MD"
