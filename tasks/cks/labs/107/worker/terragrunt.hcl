...
inputs = {
  ...
  work_pc = {
    ...
    test_url          = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-156/tasks/cks/labs/107/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-156/tasks/cks/labs/107/worker/files/worker.sh"
    ssh = {
