...
> **Версия Kubernetes и экзамен.** Курс ориентирован на Kubernetes `v1.36`. CKS - практический, performance-based экзамен: 2 часа работы в терминале с кластерами и нодами; проходной балл - 67%. На экзамене важны проверяемый результат, аккуратная правка конфигурации компонентов и быстрый поиск в разрешённой документации.
