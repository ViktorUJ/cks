...
Продолжение именно для native Cilium mTLS (без Istio sidecar) - **лаба 115: Cilium
Mutual Authentication на SPIRE** (advanced/production track, не входит в формальный CKS
Core exam requirement): [tasks/cks/labs/115](../../labs/115/README_RU.MD).
