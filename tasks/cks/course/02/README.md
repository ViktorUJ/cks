...
- **Images and supply chain.** A `latest` tag, unknown registry, dependency with a CVE, or substituted build artifact creates a threat before a Pod runs. Use digests, scanning, SBOMs, signing, and admission policy.
