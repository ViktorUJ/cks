...
inputs = {
  ...
  k8s_master = {
    ...
    cidrs              = ["0.0.0.0/0"]
    utils_enable       = "false"
    task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/mock-28-04-2023/tasks/cks/203/scripts/master.sh"
...
#   runtime            = "containerd"
#   runtime_script     = "template/runtime.sh"
#   task_script_url    = "https://raw.githubusercontent.com/ViktorUJ/cks/master/tasks/cks/201/scripts/worker.sh"
