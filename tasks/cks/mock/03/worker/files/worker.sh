...
cd /opt/course/9/
wget https://raw.githubusercontent.com/ViktorUJ/cks/AG-119/tasks/cks/mock/03/worker/files/profile

mkdir -p /var/work/14/
cd /var/work/14/
wget https://raw.githubusercontent.com/ViktorUJ/cks/AG-119/tasks/cks/mock/03/worker/files/14/Dockerfile
