...
inputs = {
  ...
  work_pc = {
    ...
    test_url          = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-119/tasks/cks/mock/03/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/AG-119/tasks/cks/mock/03/worker/files/worker.sh"
    ssh               = {
