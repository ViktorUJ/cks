...
cd /opt/course/9/
wget https://raw.githubusercontent.com/ViktorUJ/cks/0.18.1/tasks/cks/mock/02/worker/files/profile

mkdir -p /var/work/14/
cd /var/work/14/
wget https://raw.githubusercontent.com/ViktorUJ/cks/0.18.1/tasks/cks/mock/02/worker/files/14/Dockerfile
