...
inputs = {
  ...
  work_pc = {
    ...
    test_url          = "https://raw.githubusercontent.com/ViktorUJ/cks/0.18.1/tasks/cks/mock/02/worker/files/tests.bats"
    task_script_url   = "https://raw.githubusercontent.com/ViktorUJ/cks/0.18.1/tasks/cks/mock/02/worker/files/worker.sh"
    ssh               = {
