...
kubectl  apply -f https://raw.githubusercontent.com/ViktorUJ/cks/AG-92/tasks/cks/mock/01/k8s-8/scripts/task1.yaml


curl "https://raw.githubusercontent.com/ViktorUJ/cks/AG-92/tasks/cks/mock/01/k8s-8/scripts/admission_config.json" -o "admission_config.json"
curl "https://raw.githubusercontent.com/ViktorUJ/cks/AG-92/tasks/cks/mock/01/k8s-8/scripts/admission_kube_config.yaml" -o "admission_kube_config.yaml"
