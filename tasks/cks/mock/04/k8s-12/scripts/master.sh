#!/bin/bash
echo " *** master node cks mock4 k8s-12"
...
kubectl apply -f https://raw.githubusercontent.com/ViktorUJ/cks/refs/heads/master/tasks/cks/mock/04/k8s-12/scripts/app.yaml
