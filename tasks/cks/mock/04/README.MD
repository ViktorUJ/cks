...
---
|         **3**       | **falco**  Detect and Stop Unauthorized Memory Access   . в фалко не видны k8 тэги .                                                                                                                                                                    |
|:-------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|      **19**     4       | создать ингресс . с https / и редиректом с http ->https                                                                                                          |
|:-----------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|    **2**      5     | **Image Vulnerability Scanning**  bom    / в деплойменте несколько контейнеров . найти в каком имадже контейнера  содержится либа определенной верси . удалить этот контейнер из деплоймента . и для этого имаджа сохранить результат скана в определенном формате .                                                                                                                                                                                                                                                                                                                                                                                        |
|:-------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     Task weight     | 3%                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|       Cluster       | cluster1 (`kubectl config use-context cluster1-admin@cluster1`)    #cluster 6                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
---
---
|    **10**     8     | **Deployment security**        user ID , эскалейшен  и рут реадонли .                                                                                                                          |
|:-------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     Task weight     | 6%                                                                                                                                                                                             |
|       Cluster       | cluster6 (`kubectl config use-context cluster6-admin@cluster6`)                                                                                                                                |
...
---
|    **15**    10     | **Pod Security Standard**   на неймспейсе включен . в режиме рестрикт . не стартует под . пофиксить деплоймент .                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|:-------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     Task weight     | 6%                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|       Cluster       | cluster6 (   `kubectl config use-context    cluster6-admin@cluster6`   )                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
---
---
|      **20**    12       | disable sa secret auto-mount.  mount it to specific path.                                                                                                                                               |
|:-----------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     **Task weight**     | 3%                                                                                                                                                                                                      |
|       **Cluster**       | cluster6 (`kubectl config use-context cluster6-admin@cluster6`)                                                                                                                                         |
...
|           13            | создать сикрет tls из файлов . есть деплоймент  с настроенными маунтами . проверить что повилось в поде                                                                                                 |
|:-----------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     **Task weight**     |                                                                                                                                                                                                      |
|       **Cluster**       | cluster6 (`kubectl config use-context cluster6-admin@cluster6`)                                                                                                                                         |
| **Acceptance criteria** |  |
...
|           14            | обновить рабочую ноду в кластере до версии контрол плейна |
|:-----------------------:|:----------------------------------------------------------|
|     **Task weight**     |                                                           |
