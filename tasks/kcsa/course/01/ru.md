...
flowchart TB
    start["Глава 01: формат и план"] --> foundation["Главы 02-06<br/>фундамент и Overview"]
    foundation --> core["Главы 07-18<br/>компоненты, основы, угрозы, платформа"]
    core --> frameworks["Глава 19<br/>комплаенс и фреймворки"]
    frameworks --> exam["Глава 20 и моки<br/>повторение по весам доменов"]
