...
> **Формат экзамена и версия примеров.** KCSA - экзамен с выбором ответа. По правилам Linux Foundation, проверенным 1 сентября 2026 года, стандартный MCQ-экзамен (multiple choice question, вопрос с выбором ответа) содержит 60 вопросов, длится 90 минут и требует 75% для прохождения; hands-on заданий нет. Перед регистрацией обязательно повторно проверьте актуальные требования LF, так как эти параметры могут измениться. Примеры курса ориентированы на Kubernetes `v1.36`. Актуальные веса, источники и дрейф программы зафиксированы в [политике версий](../VERSION_POLICY.md).
