...
KCSA проверяет концептуальное понимание безопасности cloud native и Kubernetes. Это online proctored экзамен с вопросами multiple choice, а не практическая работа в командной строке. **По правилам Linux Foundation, проверенным 1 сентября 2026 года, стандартный MCQ-экзамен содержит 60 вопросов, длится 90 минут и требует 75% для прохождения.**
