...
При обнаружении нарушения не всегда правильно немедленно применять самый строгий режим. Например, PSS или policy engine сначала включают в `audit` или `warn`, оценивают реальные нарушения и исправляют шаблоны деплоя. После согласованного перехода правило переводят в `enforce`. Так технический control становится устойчивым процессом, а не разовой проверкой.
