...
locals {
  ...
  backend_bucket         = "sre-learning-platform-state-bucket"  # update to your own name
  backend_dynamodb_table = "${local.backend_bucket}-lock" # will be created automatically
}
```
