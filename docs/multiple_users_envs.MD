...
`` 
USER_ID='myuser' ENV_ID='3' TASK=01 make run_ckad_mock
``
create environment '3' for user 'myuser' with task set '01' ckad mock 

``
USER_ID='myuser' ENV_ID='3' TASK=01 make delete_ckad_mock
``

delete environment '3' for user 'myuser' with job set '01' ckad mock 
